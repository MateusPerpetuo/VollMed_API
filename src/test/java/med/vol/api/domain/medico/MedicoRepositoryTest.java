...
@DataJpaTest // Notação de teste da camada de persistencia de dados usando JPA
// Anotação  v para o Sprig usar o BD da applicação no teste e nao o BD em memória
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@ActiveProfiles("teste") // Falando pro Spring ler a application-teste.properties
